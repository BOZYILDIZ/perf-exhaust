        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                {advantages.map((a, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <a.icon size={16} className="text-brand-500 flex-shrink-0" />
            ...
            <div className="p-6 border" style={{ background: "rgba(18,102,234,0.04)", borderColor: "rgba(18,102,234,0.2)" }}>
              <h3 className="text-brand-400 font-bold text-sm tracking-widest uppercase mb-3">Prix sur devis</h3>
            ...
            <div className="p-6 border" style={{ background: "#0f0f0f", borderColor: "#1e1e1e" }}>
              ...
              <div className="space-y-2">
                <a href="tel:+33636523058" className="flex items-center gap-2 text-gray-400 text-sm hover:text-brand-400 transition-colors">
                  <Phone size={14} className="text-brand-500" /> +33 6 36 52 30 58
                </a>
                <a href="mailto:contact@perfexhaust.fr" className="flex items-center gap-2 text-gray-400 text-sm hover:text-brand-400 transition-colors">
                  <span className="text-brand-500 text-xs">✉</span> contact@perfexhaust.fr
                </a>
              </div>
